#############################################################################
# Makefile for building: mugatucoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat May 10 20:21:03 2014
# Project:  mugatucoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mugatucoin-qt.pro
#############################################################################
...
Makefile: mugatucoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile mugatucoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/MugatuCoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/MugatuCoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/MugatuCoin/src/leveldb/libleveldb.a: FORCE
