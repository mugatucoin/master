...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.19 * COIN;	// 19% annual interest
...
static const uint256 hashGenesisBlock("000002241bbe26146003b9296554469c99d9465f18f52d59de3be382fa48829f");
