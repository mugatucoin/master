...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MugatuCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MugatuCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"node1.mugatucoin.com", "node1.mugatucoin.com"},
	{"node2.mugatucoin.com", "node2.mugatucoin.com"},
    {"node3.mugatucoin.com", "node3.mugatucoin.com"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("MugatuCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MugatuCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MugatuCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MugatuCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MugatuCoin is probably already running."), addrBind.ToString().c_str());
        else
